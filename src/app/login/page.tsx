            ...
            {isLogin ? (
              <Form {...loginForm}>
                ...
                >
                  ...
                  />
                  <Button type="submit" className="w-full transition-all duration-200 hover:scale-110 cursor-pointer" disabled={isLoading}>
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full transition-all duration-200 hover:scale-110 cursor-pointer"
                    disabled={isLoading}
