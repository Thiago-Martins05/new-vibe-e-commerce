            ...
            {isLogin ? (
              <Form {...loginForm}>
                ...
                >
                  ...
                  />
                  <Button type="submit" className="w-full hover-zoom-button cursor-pointer" disabled={isLoading}>
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full hover-zoom-button cursor-pointer"
                    disabled={isLoading}
          ...
          <CardFooter className="flex justify-center">
            <div className="text-center">
              ...
              <Button
                type="button"
                variant="link"
                className="p-0 text-sm hover-zoom-button cursor-pointer"
                onClick={toggleMode}
              >
